...
```{r,echo=TRUE}
# Feature Scaling
ames_raw_2008$Lot_Area_scaled <- scale(ames_raw_2008$`Lot Area`)
ames_raw_2008$Garage_Area_scaled <- scale(ames_raw_2008$`Garage Area`)
ames_raw_2008$Gr_Liv_Area_scaled <- scale(ames_raw_2008$`Gr Liv Area`)

# Feature Transformation
ames_raw_2008$Lot_Area_log <- log(ames_raw_2008$`Lot Area`)
ames_raw_2008$Garage_Area_log <- log(ames_raw_2008$`Garage Area`)
ames_raw_2008$Gr_Liv_Area_log <- log(ames_raw_2008$`Gr Liv Area`)

# Dummy Variables
ames_raw_2008_1 <- model.matrix(~ Neighborhood + `Exterior 1st` + `Exterior 2nd` - 1, data = ames_raw_2008)

# Combining Features
ames_raw_2008$Total_Bathrooms <- ames_raw_2008$`Full Bath` + (0.5 * ames_raw_2008$`Half Bath`)

# Interaction Terms
ames_raw_2008$Year_Remod_Built_interaction <- ames_raw_2008$`Year Remod/Add` * ames_raw_2008$`Year Built`

# Fit full model
selected_columns <- ames_raw_2008[, c("Year Remod/Add", "Year Built", "Lot_Area_log","Garage_Area_log","Gr_Liv_Area_log","Year_Remod_Built_interaction","SalePrice")]
selected_columns <- na.omit(selected_columns)
selected_columns <- selected_columns[apply(selected_columns, 1, function(row) !any(is.infinite(row))), , drop = FALSE]
full_model <-lm(log(SalePrice) ~ `Year Remod/Add` + `Year Built` + Lot_Area_log + Garage_Area_log + Gr_Liv_Area_log + Year_Remod_Built_interaction, data = selected_columns)
...
~~~
According to the R-squared value, the model after feature engerineering is better than the original model.
